    ...
    def test_adapters_normalize_runtime_outputs(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            (modules / "needle.py").write_text(
                ...
                "        assert parameters['properties']['food_name']['description'] == 'Food name only'\n"
                "        assert parameters['properties']['quantity']['description'] == 'the amount of the food'\n"
                "        assert parameters['properties']['unit']['description'] == 'the unit the quantity is in'\n"
                "        assert 'exclusiveMinimum' not in parameters['properties']['quantity']\n"
